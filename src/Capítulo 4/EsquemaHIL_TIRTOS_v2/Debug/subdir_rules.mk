...
build-2054006529:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-2054006529-inproc

build-2054006529-inproc: ../memoria_sysbios_v2.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-2054006529 ../memoria_sysbios_v2.cfg
configPkg/compiler.opt: build-2054006529
configPkg: build-2054006529
