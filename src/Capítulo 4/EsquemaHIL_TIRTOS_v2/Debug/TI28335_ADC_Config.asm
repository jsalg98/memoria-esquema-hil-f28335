...
;	C:\ti\ccs1271\ccs\tools\compiler\ti-cgt-c2000_22.6.1.LTS\bin\ac2000.exe -@C:\\Users\\jsalg\\AppData\\Local\\Temp\\{44023CCE-B2AA-48C8-BC3B-8039B5F31DDA} 
...
$C$DW$6	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$6, DW_AT_TI_begin_line(0x19)
	.dwattr $C$DW$6, DW_AT_TI_begin_column(0x06)
	.dwattr $C$DW$6, DW_AT_TI_max_frame_size(-2)
	.dwpsn	file "../TI28335_ADC_Config.c",line 25,column 22,is_stmt,address _ADC_Config,isa 0
...
_ADC_Config:
 ...
 EALLOW
	.dwpsn	file "../TI28335_ADC_Config.c",line 27,column 5,is_stmt,isa 0
        MOVW      DP,#_SysCtrlRegs+10   ; [CPU_ARAU] 
        MOVB      @$BLOCKED(_SysCtrlRegs)+10,#3,UNC ; [CPU_ALU] |27| 
 ...
 EDIS
	.dwpsn	file "../TI28335_ADC_Config.c",line 30,column 5,is_stmt,isa 0
        ...
        OR        @$BLOCKED(_AdcRegs),#0x4000 ; [CPU_ALU] |30| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 32,column 5,is_stmt,isa 0
 RPT #22 || NOP
	.dwpsn	file "../TI28335_ADC_Config.c",line 34,column 5,is_stmt,isa 0
 EALLOW
	.dwpsn	file "../TI28335_ADC_Config.c",line 35,column 5,is_stmt,isa 0
        MOVW      DP,#_SysCtrlRegs+12   ; [CPU_ARAU] 
        OR        @$BLOCKED(_SysCtrlRegs)+12,#0x0008 ; [CPU_ALU] |35| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 36,column 5,is_stmt,isa 0
        SPM       #0                    ; [CPU_ALU] 
$C$DW$7	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$7, DW_AT_TI_call
        ...
        LCR       #_ADC_cal             ; [CPU_ALU] |36| 
        ; call occurs [#_ADC_cal] ; [] |36| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 37,column 5,is_stmt,isa 0
 EDIS
	.dwpsn	file "../TI28335_ADC_Config.c",line 39,column 5,is_stmt,isa 0
        MOVW      DP,#_AdcRegs+28       ; [CPU_ARAU] 
        AND       @$BLOCKED(_AdcRegs)+28,#0x3fff ; [CPU_ALU] |39| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 41,column 5,is_stmt,isa 0
        MOVB      @$BLOCKED(_AdcRegs)+24,#224,UNC ; [CPU_ALU] |41| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 48,column 5,is_stmt,isa 0
        MOVL      XAR4,#149990          ; [CPU_ARAU] |48| 
        SPM       #0                    ; [CPU_ALU] 
        MOVL      ACC,XAR4              ; [CPU_ALU] |48| 
$C$DW$8	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$8, DW_AT_low_pc(0x00)
	.dwattr $C$DW$8, DW_AT_name("_DSP28x_usDelay")
	.dwattr $C$DW$8, DW_AT_TI_call

        LCR       #_DSP28x_usDelay      ; [CPU_ALU] |48| 
        ; call occurs [#_DSP28x_usDelay] ; [] |48| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 50,column 5,is_stmt,isa 0
        MOVW      DP,#_AdcRegs+2        ; [CPU_ARAU] 
        MOV       @$BLOCKED(_AdcRegs)+2,#0 ; [CPU_ALU] |50| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 55,column 5,is_stmt,isa 0
        AND       @$BLOCKED(_AdcRegs)+3,#0xfff0 ; [CPU_ALU] |55| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 57,column 5,is_stmt,isa 0
        MOV       @$BLOCKED(_AdcRegs),#1296 ; [CPU_ALU] |57| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 68,column 5,is_stmt,isa 0
        MOV       @$BLOCKED(_AdcRegs)+1,#2304 ; [CPU_ALU] |68| 
	.dwpsn	file "../TI28335_ADC_Config.c",line 85,column 1,is_stmt,isa 0
$C$DW$9	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$6, DW_AT_TI_end_line(0x55)
