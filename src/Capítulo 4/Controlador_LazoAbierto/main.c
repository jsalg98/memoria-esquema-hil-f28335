...
// ***** Define ********************************************************************************************************
#define PWM_PERIOD  7500   // 10 kHz
#define PWM_DUTY_CYCLE  0.5*PWM_PERIOD   // 50% Duty Cycle

// ***** Prototypes ****************************************************************************************************
void InitSysCtrl(void);
void InitPieCtrl(void);
void InitAdc(void);
void ConfigPwm1A(void);
void ConfigGpio(void);
void ConfigGpioEpwm1a(void);
...
void ConfigGpio(){
    ...
    GpioCtrlRegs.GPAPUD.all   = 0x00000000;     // Pull-ups enabled GPIO31-12
    ...
    GpioCtrlRegs.GPBPUD.all   = 0x00000000;     // Pull-ups enabled GPIO 48-32
    ...
    GpioCtrlRegs.GPCPUD.all = 0x00000000;       // All group C Pull-ups enabled
...
// ***** ConfigGpioEpwm1a **********************************************************************************************
void ConfigGpioEpwm1a(){
    EALLOW;
    GpioCtrlRegs.GPAPUD.bit.GPIO0 = 1;   // Pull-up disabled GPIO0
    GpioCtrlRegs.GPAMUX1.bit.GPIO0 = 1;  // GPIO0 set as ePWM1A
    GpioCtrlRegs.GPADIR.bit.GPIO0 = 1;   // GPIO0 set as output
    EDIS;
}
